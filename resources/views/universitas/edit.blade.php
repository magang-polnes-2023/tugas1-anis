            ...
            <fieldset class="row mb-3">
                ...
                <div class="col-sm-10">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="akreditasi" id="akreditasi1" value="A"{{$universitas->akreditasi}}checked>
                    <label class="form-check-label" for="akreditasi1">
                      A
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="akreditasi" id="akreditasi2" value="B"{{$universitas->akreditasi}}>
                    <label class="form-check-label" for="akreditasi2">
                      B
                    </label>
                  </div>
                  <div class="form-check disabled">
                    <input class="form-check-input" type="radio" name="akreditasi" id="akreditasi3" value="C"{{$universitas->akreditasi}} >
